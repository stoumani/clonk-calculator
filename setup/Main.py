from tkinter import BOTTOM, BOTH, TOP, Label, DISABLED, NORMAL, INSERT, END, messagebox, ttk
...
class App:
    def __init__(self):
        Windows.CreateWindow(self)
        self.FirstExecutionSettings()
        self.SetScreens()
        Buttons.CreateButtons(self)
    ...
    def SetScreens(self):
        # First screen
        self.firstScreen = Label(self.screensFrame, textvariable=self.firstScreenText, font=self.mainWindowFont,
                                 anchor="e")
        ...
        # Second screen
        self.secondScreen = Label(self.screensFrame, textvariable=self.secondScreenText, font=self.secondaryWindowFont,
                                  anchor="e")
    ...
    def firstScreenTextSet(self, num):
        # Analyzing if there are parenthesis (precision)
        if num == "(":
    ...
    # Function to use on Clear button
    def C(self):
        self.firstScreenText.set("0")
        self.secondScreenText.set("0")
        return

    # Function to use Delete button
    def Delete(self):
    ...
    def plotFunction(self):
        ...
        self.toolbar = NavigationToolbar2Tk(self.canvas, self.plottingFrame)
